...
export type MakethingsAction = FileAction | ShellAction | StartAction | BuildAction | SupabaseAction;

export type MakethingsActionData = MakethingsAction | BaseAction;
